      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          <FooterList title="Navegação">
              ...
              <li><FooterLink onClick={() => navigate('/events')}>Eventos</FooterLink></li>
          ...
          <FooterList title="Sobre">
              <li><FooterLink onClick={() => navigate('/about')}>Quem Somos</FooterLink></li>
              ...
              <li><FooterLink onClick={() => navigate('/transparency')}>Transparência</FooterLink></li>
              <li><FooterLink onClick={() => navigate('/annual-report')}>Relatório Anual</FooterLink></li>
