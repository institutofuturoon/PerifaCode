  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-6rem)] relative overflow-hidden bg-[#09090B]">
      ...
      <div className="w-full max-w-[400px] z-10 p-6">
        <div className="bg-[#121212]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden ring-1 ring-white/5">
            <div className="p-8 pt-12 pb-10">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-xs text-gray-400 mt-1.5">Acesse sua conta para continuar sua jornada.</p>
                </div>
        ...
        <div className="mt-8 text-center flex justify-center gap-6 text-[10px] text-gray-500 font-medium tracking-wide uppercase">
            ...
            <button className="hover:text-gray-300 transition-colors">Esqueceu a senha?</button>
        </div>
      </div>
    </div>
  );
