      ...
      <div className="max-w-md w-full space-y-8 bg-black/20 backdrop-blur-xl p-10 rounded-2xl border border-white/10 shadow-2xl shadow-[#8a4add]/10">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleRegister}>
            ...
            <div className="flex items-start bg-white/5 p-3 rounded-lg border border-white/10">
                ...
                <div className="ml-3 text-sm">
                    <label htmlFor="terms" className="font-medium text-gray-300 cursor-pointer">
                        Li e concordo com os <button type="button" onClick={() => navigate('/terms')} className="text-[#8a4add] hover:underline font-bold">Termos de Uso</button> e <button type="button" onClick={() => navigate('/privacy')} className="text-[#8a4add] hover:underline font-bold">Política de Privacidade</button>.
                    </label>
                </div>
            </div>
          </div>
         ...
         <p className="mt-4 text-center text-sm text-gray-400">
            Já tem uma conta?{' '}
            <button onClick={() => navigate('/login')} className="font-medium text-[#c4b5fd] hover:text-[#8a4add] hover:underline transition-colors">
              Faça login
            </button>
          </p>
      </div>
