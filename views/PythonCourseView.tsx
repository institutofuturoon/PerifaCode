...
const InscriptionFormModal: React.FC<InscriptionFormModalProps> = ({ isOpen, onClose, courseName = "Programação Python" }) => {
...
const PythonCourseView: React.FC = () => {
    const { navigate } = useAppContext();
        ...
        <div className="aurora-background text-white">
            <main>
                ...
                <section className="pt-32 pb-32 md:pt-40 md:pb-40 text-center relative z-10 bg-grid-pattern">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-tight">
                            Do Zero ao Código,<br />
                            <span className="text-[#c4b5fd]">com Python.</span>
                        </h1>
                        <p className="mt-6 max-w-3xl mx-auto text-lg md:text-xl text-gray-300 leading-relaxed">
                            Aprenda a programar com uma das linguagens mais populares do mercado. Desenvolva sua lógica, crie seus primeiros projetos e abra portas para uma nova carreira em tecnologia.
                        </p>
                         <div className="mt-10">
                ...
                <Section className="bg-black/20">
                    <SectionTitle subtitle="Simples, poderosa e em alta no mercado. Descubra por que Python é a escolha ideal para quem está começando.">
                        Por que Python é a Melhor Porta de Entrada para a Programação?
                    </SectionTitle>
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        <BenefitCard icon="🎓" title="Fácil de Aprender" description="Sintaxe limpa e intuitiva, ideal para quem nunca programou. Você vai escrever seu primeiro 'Olá, Mundo!' em minutos." />
                        <BenefitCard icon="🚀" title="Porta para o Futuro" description="Dominar Python abre caminhos para áreas como Inteligência Artificial, Análise de Dados e Desenvolvimento Web." />
                        <BenefitCard icon="💰" title="Salários Atrativos" description="Profissionais de Python são muito valorizados, com salários iniciais competitivos que crescem com a sua experiência." />
                        <BenefitCard icon="🌎" title="Comunidade Gigante" description="Conte com uma das maiores comunidades de desenvolvedores do mundo para tirar dúvidas e colaborar em projetos." />
                    </div>
                </Section>
                
                {/* Curriculum Section */}
                <Section>
                     <SectionTitle subtitle="Nossa trilha foi desenhada para te levar do zero absoluto até a construção de um projeto prático e relevante para o seu portfólio.">
                        Uma Jornada Completa, do Básico ao seu Primeiro Projeto
                    </SectionTitle>
                    <div className="max-w-4xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-8 md:p-12">
                        <div className="grid md:grid-cols-2 gap-8">
                            <CurriculumItem title="Lógica de Programação Essencial" description="Construa a base de todo dev: como pensar de forma estruturada para resolver problemas com código." />
                            <CurriculumItem title="Fundamentos do Python" description="Domine variáveis, tipos de dados, operadores e as estruturas que formam a linguagem." />
                            <CurriculumItem title="Estruturas de Controle" description="Aprenda a criar condicionais (if/else) e laços de repetição (for/while) para dar vida aos seus programas." />
                            <CurriculumItem title="Funções e Organização" description="Escreva código limpo e reutilizável, organizando seus projetos de forma profissional." />
                            <CurriculumItem title="Estruturas de Dados" description="Trabalhe com listas, tuplas e dicionários para manipular e organizar informações de forma eficiente." />
                            <CurriculumItem title="Projeto Prático Final" description="Aplique todo o seu conhecimento construindo uma aplicação do mundo real, pronta para o seu portfólio." />
                        </div>
                    </div>
                </Section>
                ...
                <Section>
                    <div className="text-center bg-grid-pattern p-8 md:p-16 rounded-2xl border border-[#8a4add]/20" style={{backgroundImage: 'radial-gradient(circle at center, #8a4add10, transparent 60%)'}}>
                        <h2 className="text-3xl md:text-4xl font-black text-white">Sua Carreira em Tech Começa Agora</h2>
                        <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-300">
                           Não espere mais para investir no seu futuro. As vagas são limitadas. Preencha o formulário e garanta seu interesse na próxima turma!
                        </p>
                        <div className="mt-8">
                             <button onClick={() => setIsFormOpen(true)} className="inline-block bg-gradient-to-r from-[#8a4add] to-[#f27983] text-white font-bold py-3 px-8 rounded-lg hover:opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-[#8a4add]/30">
                                Inscreva-se Agora
            ...
            <InscriptionFormModal isOpen={isFormOpen} onClose={() => setIsFormOpen(false)} courseName="Programação em Python" />
        </div>
    );
};
