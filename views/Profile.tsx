    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="max-w-3xl mx-auto bg-black/20 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl shadow-[#8a4add]/10 overflow-hidden">
        ...
        <div className="relative">
            ...
            >
                {/* Banner Edit Button - Future Feature */}
                <button className="absolute top-4 right-4 bg-black/50 p-2 rounded-full text-white hover:bg-black/70 transition-colors text-xs">
                    ✏️
                </button>
            </div>
        ...
        <div className="p-8 pt-20 text-center">
            ...
            <p className="mt-4 text-gray-300 max-w-xl mx-auto">{user.bio}</p>
