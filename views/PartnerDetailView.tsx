    ...
    if (!partner) {
        return (
            <div className="min-h-screen bg-[#09090B] flex flex-col items-center justify-center">
                ...
                <button onClick={() => navigate('/supporters')} className="text-[#c4b5fd] hover:underline">Retornar à Base</button>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#09090B] text-white font-sans selection:bg-[#8a4add] selection:text-white">
            ...
            <nav className="fixed top-0 w-full z-50 bg-[#09090B]/80 backdrop-blur-md border-b border-white/5 h-16 flex items-center px-6">
                <button onClick={() => navigate('/supporters')} className="text-sm font-bold text-gray-400 hover:text-white flex items-center gap-2 transition-colors">
