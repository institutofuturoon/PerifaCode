...
import { useContactInfo } from '../hooks/useOngData';
...
const WhatsAppButton: React.FC = () => {
  ...
  const handleClick = () => {
    const phoneNumber = contact.phones.whatsapp.replace(/\D/g, '');
    const message = encodeURIComponent('Olá! Gostaria de saber mais sobre o Instituto FuturoOn.');
  ...
  return (
    <>
      ...
      {/* Tooltip */}
      {isHovered && isVisible && (
        <div className="fixed bottom-6 right-24 md:right-28 z-50 animate-fade-in">
          <div className="bg-white text-gray-900 px-4 py-2 rounded-lg shadow-xl border border-gray-200 whitespace-nowrap">
            ...
            <p className="text-xs text-gray-600">Estamos online</p>
          </div>
          {/* Arrow */}
