        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-4">
            <button
              ...
              className={`px-4 md:px-6 py-2 rounded-full font-bold text-xs md:text-sm transition-all duration-300 ${
                timeFilter === 'upcoming'
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3">
            <button
              ...
              className={`px-3 md:px-4 py-1.5 md:py-2 rounded-full font-bold text-xs transition-all duration-300 ${
                categoryFilter === 'all'
