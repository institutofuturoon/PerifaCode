        ...
        <div className="bg-[#09090B] min-h-screen relative overflow-x-hidden">
            ...
            />
             ...
             <div className="absolute top-0 left-0 w-full z-50 p-6 flex justify-between items-center pointer-events-none">
                <button onClick={() => navigate('/cursos')} className="pointer-events-auto text-white/70 hover:text-white font-semibold transition-colors group text-sm flex items-center gap-2 bg-black/20 backdrop-blur-md py-2 px-4 rounded-full border border-white/10 hover:border-white/20">
                    <span className="inline-block transform group-hover:-translate-x-1 transition-transform">&larr;</span>
                    Voltar
                </button>
                {!user && (
                    <button onClick={() => navigate('/entrar')} className="pointer-events-auto text-sm font-bold text-white bg-white/10 hover:bg-white/20 backdrop-blur-md py-2 px-6 rounded-full transition-colors border border-white/10">
                        Login
                    </button>
                )}
            </div>
