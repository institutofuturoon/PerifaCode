...
const Home: React.FC = () => {
    ...
    return (
        <>
            ...
            {/* Banner de Conquista - Hostinger Start - COMPACTO */}
            <section className="py-6 md:py-10 relative z-10 overflow-hidden">
                {/* Background effects melhorados */}
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/5 via-orange-500/5 to-yellow-600/5"></div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="flex items-center justify-center mb-4">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/40">
                                ...
                                <span className="text-xs md:text-sm font-bold text-yellow-300 uppercase tracking-wider">Conquista Recente</span>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            {/* Glow effect */}
                            <div className="absolute -inset-1 bg-gradient-to-r from-yellow-500/20 via-orange-500/20 to-yellow-500/20 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                            
                            <div className="relative bg-gradient-to-br from-white/[0.07] to-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8 shadow-xl">
                                ...
                                {/* Descrição compacta */}
                                <p className="text-sm md:text-base text-gray-300 text-center max-w-2xl mx-auto leading-relaxed mb-4">
                                    Reconhecidos por <span className="text-white font-semibold">impulsionar sonhos de negócio online</span> e transformar vidas através da tecnologia.
                                </p>

                                {/* Detalhes compactos */}
                                <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4 mb-4">
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-full border border-white/10 text-xs md:text-sm">
                                        <svg className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                        </svg>
                                        <span className="font-bold text-white">Prêmio 2025</span>
                                    </div>
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-full border border-white/10 text-xs md:text-sm">
                                        <svg className="w-4 h-4 text-[#8a4add]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                        </svg>
                                        <span className="font-semibold text-gray-300">Impacto Social</span>
                                    </div>
                                </div>
                                ...
                                <div className="text-center">
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-[#8a4add] to-[#f27983] rounded-full text-white font-bold text-sm hover:shadow-lg hover:shadow-[#8a4add]/30 transition-all duration-300 hover:scale-105"
                                    >
