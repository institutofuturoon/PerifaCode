            ...
            `}>
                ...
                <div className="p-6 border-b border-white/5 bg-[#050505]">
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <button onClick={() => navigate('/painel')} className="flex items-center gap-2 text-xs font-bold text-gray-500 hover:text-white transition-colors mb-2 group">
                    ...
                    <div className="mt-16 pt-8 border-t border-white/10 flex justify-between items-center">
                        ...
                        <button 
                            onClick={() => {
                                ...
                                else { handleCompleteLesson(); navigate('/painel'); }
                            }}
