                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-gray-400 text-sm">
                            💡 Emitimos recibos e relatórios de impacto para fins de comprovação ESG
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 max-w-3xl">
                    ...
                    <div className="bg-white/5 rounded-2xl border border-white/10 p-2">
                        <FAQItem
                            ...
                            answer="Prezamos pela transparência total. Emitimos recibos de todas as doações e enviamos relatórios periódicos de impacto e uso dos recursos para nossos parceiros."
                        />
                        <FAQItem
